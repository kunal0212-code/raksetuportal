...
import { bloodBanks, getStates, getDistricts, searchBlood } from '../data/bloodBanks';
...
const BloodAvailability = () => {
    ...
    const districts = useMemo(() => filters.state ? getDistricts(filters.state) : [], [filters.state]);
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        const searchResults = searchBlood(filters);
        ...
        <div className="ba-page">
            <section className="ba-hero">
                <div className="container">
                    ...
                    <p>Search real-time blood stock across {bloodBanks.length}+ verified blood banks in India.</p>
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    {!hasSearched && (
                        <div className="ba-initial">
                            ...
                            <p>Use the filters above to search for blood across {bloodBanks.length}+ verified blood banks.</p>
                        </div>
                    )}
                </div>
            </section>
